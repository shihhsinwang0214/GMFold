...
def ty_fold(seq: str, temp: float = 37.0) -> List[Struct]:
    ...
    v_cache,   min_struct= _cache(seq, temp, S, D)
    n = len(seq)
...
def _cache(seq: str, temp: float = 37.0, S= None, D = None) :
