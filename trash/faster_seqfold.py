...
from graph_matching import  Aptamer_Fold
...
def faster_fold(seq: str, temp: float = 37.0) -> List[Struct]:
    ...
    v_cache, w_cache = _cache(seq, temp, S, M)
    n = len(seq)
...
def _cache(seq: str, temp: float = 37.0, S = None, M = None) -> Tuple[Structs, Structs]:
